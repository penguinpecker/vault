        ...
        >
          ...
          <View style={styles.requirements}>
            <View style={styles.requirement}>
              <CheckIcon color={hasMinLength ? '#22c55e' : theme.colors.grey[600]} />
              <Text style={[styles.requirementText, hasMinLength && styles.requirementMet]}>
                At least 8 characters
              </Text>
            </View>
            <View style={styles.requirement}>
              <CheckIcon color={hasUpperCase ? '#22c55e' : theme.colors.grey[600]} />
              <Text style={[styles.requirementText, hasUpperCase && styles.requirementMet]}>
                One uppercase letter
              </Text>
            </View>
            <View style={styles.requirement}>
              <CheckIcon color={hasNumber ? '#22c55e' : theme.colors.grey[600]} />
